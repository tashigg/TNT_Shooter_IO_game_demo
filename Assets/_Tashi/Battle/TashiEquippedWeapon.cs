...
[System.Serializable]
public struct TashiEquippedWeapon
{
    public static readonly TashiEquippedWeapon Empty = new TashiEquippedWeapon();
    [HideInInspector]
    ...
    public TashiWeaponData WeaponData
    {
        ...
        {
            if (weaponData == null)
                weaponData = TashiGameInstance.GetWeapon(weaponId);
            return weaponData;
        }
    }
