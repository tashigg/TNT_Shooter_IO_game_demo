...
public class TashiCharacterMovement : MonoBehaviour
{
    ...
    public TashiCharacterEntity CacheEntity { get; private set; }
    ...
    protected virtual void Awake()
    {
        ...
        CacheEntity = gameObject.GetComponent<TashiCharacterEntity>();
