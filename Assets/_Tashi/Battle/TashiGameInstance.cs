...
public class TashiGameInstance : BaseNetworkGameInstance
{
    public static new TashiGameInstance Singleton { get; private set; }
    public TashiCharacterEntity characterPrefab;
    public BotEntity botPrefab;
    public CharacterData[] characters;
    public HeadData[] heads;
    public TashiWeaponData[] weapons;
    ...
    public static readonly List<TashiWeaponData> AvailableWeapons = new List<TashiWeaponData>();
    ...
    public static readonly Dictionary<int, TashiWeaponData> Weapons = new Dictionary<int, TashiWeaponData>();
    ...
    public static TashiWeaponData GetWeapon(int key)
    {
        if (Weapons.Count == 0)
            return null;
        TashiWeaponData result;
    ...
    public static TashiWeaponData GetAvailableWeapon(int index)
    {
