...
public class TashiGameplayManager : MonoBehaviourPunCallbacks
{
    [System.Serializable]
    ...
    public static TashiGameplayManager Singleton { get; private set; }
    ...
    {
        if (!LobbyManager.Instance._isLobbyHost || string.IsNullOrEmpty(prefabName))
            return;
    ...
    public Vector3 GetCharacterSpawnPosition(TashiCharacterEntity character)
    {
    ...
    public virtual bool CanRespawn(TashiCharacterEntity character)
    {
    ...
    public virtual bool CanReceiveDamage(TashiCharacterEntity damageReceiver, TashiCharacterEntity attacker)
    {
        var networkGameplayManager = BaseNetworkGameManager.Singleton;
        if (networkGameplayManager != null)
        {
    ...
    public virtual bool CanAttack(TashiCharacterEntity character)
    {
        var networkGameplayManager = BaseNetworkGameManager.Singleton;
        if (networkGameplayManager != null)
        {
