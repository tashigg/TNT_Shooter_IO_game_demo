...
public class TashiWeaponData : ItemData
{
    [Range(0, TashiCharacterEntity.MAX_EQUIPPABLE_WEAPON_AMOUNT - 1)]
    public int equipPosition;
    public GameObject rightHandObject;
    public GameObject leftHandObject;
    public GameObject shieldObject;
    public List<AttackAnimation> attackAnimations;
    public TashiDamageEntity damagePrefab;
    public int damage;
    [Header("Reload")]
    ...
    public void Launch(TashiCharacterEntity attacker, bool isLeftHandWeapon, Vector3 targetPosition)
    {
        if (!attacker)
            return;
        ...
        for (int i = 0; i < spread; ++i)
        {
            ...
            TashiDamageEntity.InstantiateNewEntityByWeapon(this, isLeftHandWeapon, targetPosition, attacker, addRotationX, addRotationY, spread);
        }
