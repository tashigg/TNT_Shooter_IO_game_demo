...
public class TashiIONetworkGameRule : BaseNetworkGameRule
{
    public UIGameplay uiGameplayPrefab;
    public TashiCharacterEntity overrideCharacterPrefab;
    public BotEntity overrideBotPrefab;
    public TashiWeaponData[] startWeapons;
    ...
    public virtual void NewPlayer(TashiCharacterEntity character, int selectHead, int selectCharacter, int[] selectWeapons, int[] selectCustomEquipments, string extra)
    {
